...
const Work = ({ positions, company, description, link }: Props) => {
    return (
                ...
                <div className='group flex flex-row flex-basis relative pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                    ...
                    <main className='basis-3/4 z-10'>
                        <p className="text-mtext-white font-semibold flex items-center">
                            {company}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" className="h-4 w-4 ml-1 text-mtext-white hidden lg:group-hover/work:block icon icon-tabler icons-tabler-outline icon-tabler-arrow-up-right">
