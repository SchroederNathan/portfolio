export const Socials = () => {
    return (
        <div className="fixed bottom-0 left-0 h-full w-[100px] hidden md:block">
            ...
            <a href="https://discord.gg/9w3r4u3" className="h-[24px] absolute bottom-20 left-0 right-0 m-auto transition-transform transform hover:-translate-y-1">
                <img src="images/discord.svg" className="m-auto" />
            </a>
            <a href="https://instagram.com/nathanschroederr" className="h-[24px] absolute bottom-32 left-0 right-0 m-auto transition-transform transform hover:-translate-y-1">
                <img src="images/instagram.svg" className="m-auto" />
            </a>
            <a href="https://github.com/schroedernathan" className="h-[24px] absolute bottom-44 left-0 right-0 m-auto transition-transform transform hover:-translate-y-1">
                <img src="images/github.svg" className="m-auto" />
            </a>
            <a href="https://www.linkedin.com/in/nathan-schroeder-a40aa2210/" className="h-[24px] absolute bottom-56 left-0 right-0 m-auto transition-transform transform hover:-translate-y-1">
...
export const SocialsHorizontal = () => {
    return (
        <div className=" flex md:hidden">
            ...
            <a href="https://discord.gg/9w3r4u3" className="ml-6">
                <img src="images/discord.svg" className="m-auto" />
            </a>
        </div>
    )
